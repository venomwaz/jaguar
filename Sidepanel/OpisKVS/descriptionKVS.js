document.addEventListener('DOMContentLoaded', async () => {
    ...
    const specialList = document.getElementById('specialList');
        ...
        function addShortcutToList(name, text, shortcut, category) {
            ...
            li.innerHTML = `<b><span style=\"font-size: 15px;\">${shortcut} </span></b> <span style=\"margin:0 5px 0 5px;font-size:20px;\">&#8658;</span> ${name}<span style=\"visibility:hidden;\">${category}</span>`;
            li.title = text;
